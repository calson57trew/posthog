...
const CohortsPartialUpdateSchema = CohortsPartialUpdateParams.omit({ project_id: true }).extend(CohortsPartialUpdateBody.omit({ '_create_in_folder': true, '_create_static_person_ids': true }).shape)
